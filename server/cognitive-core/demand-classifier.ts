...
export class DemandClassifier {
  ...
  private determineCategory(demand: Demand, criteria: ClassificationCriteria): DemandCategory {
    ...
    // Adjust based on demand type
    switch (demand.type) {
      case 'nova_funcionalidade':
        categoryScores.technical += 15;
        categoryScores.business += 10;
        break;
      case 'melhoria':
        categoryScores.technical += 12;
        categoryScores.analytical += 8;
        break;
      case 'bug':
        ...
        break;
      case 'discovery':
        categoryScores.research += 25;
        categoryScores.business += 10;
        break;
      case 'analise_exploratoria':
        categoryScores.analytical += 20;
        categoryScores.research += 15;
        break;
    }
