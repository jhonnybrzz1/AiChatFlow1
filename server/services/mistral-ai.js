...
exports.mistralAIService = exports.MistralAIService = void 0;
...
class MistralAIService {
     ...
     */
    async generateMultipleChatCompletions(prompts, options = {}) {
        try {
            const promises = prompts.map(prompt => this.generateChatCompletion(prompt.systemPrompt, prompt.userPrompt, options));
     ...
     */
    async generateJSONResponse(systemPrompt, userPrompt, options = {}) {
        try {
            const response = await this.client.chat.complete({
                model: options.model || DEFAULT_MODEL,
                messages: [
...
exports.mistralAIService = new MistralAIService();
